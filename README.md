...
1. Bot message arrives. On the first message of a chat, and again every **Re-seed every** messages, the appearance registry is seeded from the character cards, every bound lorebook and the chat so far
